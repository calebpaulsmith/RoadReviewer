...
Private Function CellText(ByVal ws As Worksheet, ByVal r As Long, ByVal c As Long) As String
    Select Case c
        ...
        Case COL_NFCAGOL: CellText = NfcAgolUrlForRow(ws, r)
    ...
    Select Case c
        Case COL_GMAP, COL_STREETVIEW, COL_BING, COL_GEARTH, COL_FEMAVIEW, COL_FIRMPORTAL, COL_NFCMAP, COL_NFCAGOL, COL_AGOLMAP
...
Private Function NfcMapUrlForRow(ByVal ws As Worksheet, ByVal r As Long) As String
    Select Case BareStateCodeOrMI()
        ...
        Case Else: NfcMapUrlForRow = APP_MI     ' MI or blank
    End Select
End Function
